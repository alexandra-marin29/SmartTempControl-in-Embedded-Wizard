...
)|C$;var D6=Nz^this.F;this.F=Nz;if(!!this.G&&!!(D6&0x14)){var OW=((this.F&0x14)===
...
,A.CH],this);}if(((((D6&0x100000)===0x100000)&&((DC&0x100000)===0x100000))&&((this.
...
0x10))))this.AB(0x10,0x0);if(((((D6&0x200000)===0x200000)&&((DC&0x200000)===0x200000
))&&!((this.F&0x10)===0x10))&&((this.F&0x100000)===0x100000))this.AB(0x10,0x0);if((((((
D6&0x200000)===0x200000)&&((C$&0x200000)===0x200000))&&((this.F&0x100010)===0x100010
...
As[0],As[3]-As[1]];var A9=Ah-Ae;var A1=Aa-Af;if(!DD){var D_=[(A=Au.Ax)[2]-A[0],A[
3]-A[1]];Ae=Ae-Au.Ax[0];Af=Af-Au.Ax[1];if(D_[0]!==CV[0]){var Bx=((Bg&0x4)===0x4);
var By=((Bg&0x8)===0x8);var Fb=((Bg&0x1)===0x1);if(!Bx&&(Fb||!By))Ae=((Ae*CV[0])
/D_[0])|0;if(!By&&(Fb||!Bx)){Ah=Ah-Au.Ax[0];Ah=((Ah*CV[0])/D_[0])|0;Ah=Ah-CV[0];
...
Ae=Ae+As[0];Ah=Ah+As[2];}if(D_[1]!==CV[1]){var Bz=((Bg&0x10)===0x10);var Bw=((Bg&
0x20)===0x20);var Fc=((Bg&0x2)===0x2);if(!Bz&&(Fc||!Bw))Af=((Af*CV[1])/D_[1])|0;
if(!Bw&&(Fc||!Bz)){Aa=Aa-Au.Ax[1];Aa=((Aa*CV[1])/D_[1])|0;Aa=Aa-CV[1];}else Aa=Aa-
...
Au.CW[3];var CV=[As[2]-As[0],As[3]-As[1]];var A9=Ah-Ae;var A1=Aa-Af;if(!DD){var D_=[(
A=Au.Ax)[2]-A[0],A[3]-A[1]];Ae=Ae-Au.Ax[0];Af=Af-Au.Ax[1];if(D_[0]!==CV[0]){var Bx=((
Bg&0x4)===0x4);var By=((Bg&0x8)===0x8);var Fb=((Bg&0x1)===0x1);if(!Bx&&(Fb||!By)
)Ae=((Ae*CV[0])/D_[0])|0;if(!By&&(Fb||!Bx)){Ah=Ah-Au.Ax[0];Ah=((Ah*CV[0])/D_[0])|
...
Ah=Ah-Au.Ax[2];Ae=Ae+As[0];Ah=Ah+As[2];}if(D_[1]!==CV[1]){var Bz=((Bg&0x10)===0x10
);var Bw=((Bg&0x20)===0x20);var Fc=((Bg&0x2)===0x2);if(!Bz&&(Fc||!Bw))Af=((Af*CV[
1])/D_[1])|0;if(!Bw&&(Fc||!Bz)){Aa=Aa-Au.Ax[1];Aa=((Aa*CV[1])/D_[1])|0;Aa=Aa-CV[
...
};D.H={AO:null,AS:null,Lv:null,Bk:null,D7:null,H$:null,CB:null,Bi:255,J7:0,J_:0,
...
){var A;var K=this.AS;var H3=null;var Y=AZ;var Dc=null;var Nv=!!this.D7&&(!!this.
...
Bk.Ba===K)))K.AB(C$&0x10,DC&0x10);}if(!!D6){this.F=this.F|0x8000;B.pe([this,this.
LO],this);}},R:function(C){var A;if(B.aaY(C,this.Q))return;var G4=[(A=this.Q)[2]-
A[0],A[3]-A[1]];var Ny=[C[2]-C[0],C[3]-C[1]];var I3=!B.aaX(G4,Ny);D.AX.R.call(this
,C);if((I3&&(G4[0]>0))&&(G4[1]>0)){var Ax=[].concat(AG,G4);var K=this.AO;while(!
...
},GT:function(Cs,Dq,Gk,E5,E6,OE,Gl,HU,E4,E2,E3){var A;if(!this.Bk){this.QE(Cs,Dq
,Gk,E5,E6,null,null,E4,E2,E3);return;}var G3=this.Bk;var H5=G3.Z;if(((Cs.F&0x10000
)===0x10000)&&(this.Bk.Ba!==Cs))throw new Error(DB);var BY=B._NewObject(D.L1,0);
var FE=G3.FE;var Gt=null;var Dg=null;if(!!H5){Gt=H5.Gt;Dg=H5.Dg;}if(!!H5&&!!G3.Ko
)Gt=G3.Ko;if(!!H5&&!!Gl)Dg=Gl;if(!!OE)FE=OE;if(!Dq)Dq=B._GetAutoObject(B.ach.IP);
if(!Gk)Gk=Dq;if(!E6)E6=E5;if(!E5)E5=E6;BY.FE=Gk;BY.Dg=E5;BY.Gt=E6;BY.Ko=HU;BY.Ba=
Cs;BY.Z=this.Bk.Z;this.Bk.Z=null;this.Bk=BY;if(this.CB===Cs)this.Dy(null);G3.Ba.
AB(0x0,0x10040);if(((this.F&0x40)===0x40)&&((Cs.F&0x4)===0x4))Cs.AB(0x10040,0x0);
else Cs.AB(0x10000,0x0);if(!!Dg){this.Ef(H5.Ba,Dg.Hf(),null,null,E3);this.Ef(G3.
Ba,FE.He(),null,null,true);this.Ef(BY.Ba,Dq.Fh(),E4,E2,true);}else if(!!Gt){this.
Ef(H5.Ba,Gt.Hg(),null,null,E3);this.Ef(G3.Ba,FE.He(),null,null,true);this.Ef(BY.
Ba,Dq.Fh(),E4,E2,true);}else if(!!FE){this.Ef(G3.Ba,FE.He(),null,null,E3);this.Ef(
BY.Ba,Dq.Fh(),E4,E2,true);}else this.Ef(BY.Ba,Dq.Fh(),E4,E2,E3);},QE:function(Cs
,Dq,Gk,E5,E6,Gl,HU,E4,E2,E3){var A;if(!Cs)return;if(!!this.Bk&&(this.Bk.Ba===Cs)
){this.GT(Cs,Dq,Gk,E5,E6,null,Gl,HU,E4,E2,E3);return;}if(((Cs.F&0x10000)===0x10000
...
else Cs.AB(0x10000,0x0);H1.Ba=Cs;H1.Z=this.Bk;this.Bk=H1;if(!!Dg){this.Ef(this.Bk.
Z.Ba,Dg.Hf(),null,null,E3);this.Ef(Cs,Dq.Fh(),E4,E2,true);}else this.Ef(Cs,Dq.Fh(
...
))return null;var G2=O.Z;var G6=O.X;var Kh=0x10000;if(((aFilter&0x10000)===0x10000
))Kh=0x0;while(!!G2||!!G6){if((!!G2&&(!aFilter||((A=aFilter)&&((G2.F&A)===A))))&&(
!Kh||!((A=Kh)&&((G2.F&A)===A))))return G2;if((!!G6&&(!aFilter||((A=aFilter)&&((G6.
F&A)===A))))&&(!Kh||!((A=Kh)&&((G6.F&A)===A))))return G6;if(!!G2)G2=G2.Z;if(!!G6
)G6=G6.X;}return null;},Ef:function(Fz,A5,E4,E2,E3){var A;if(!Fz)return;if(!A5)throw new
Error(Eu);if((!!A5.H||!!A5.G)||!!A5.DO)throw new Error(Ev);if(!!Fz.G&&(Fz.G!==this
))throw new Error(E1);if(!this.D7)this.D7=B._NewObject(D.On,0);A5.G=this;A5.H=Fz;
...
A5);else{var DO=B._NewObject(B.ach.KL,0);DO.NO(A5);this.D7.QL(DO,false);}},MH:function(
...
BA=O;var Gv=O.DA;while(((D0>0)&&!!Ct.Z)&&(Ct.Z.DA<=Gv)){Ct=Ct.Z;D0=D0-1;}while(((
D0<0)&&!!BA.X)&&(BA.X.DA>=Gv)){BA=BA.X;D0=D0+1;}if((Ct===O)&&(BA===O))return;if(((
...
D0<0)&&!!this.AS)&&(this.AS.DA>=Gv)){BA=this.AS;D0=D0+1;}while((((D0<0)&&!!BA)&&
!!BA.X)&&(BA.X.DA>=Gv)){BA=BA.X;D0=D0+1;}if((!BA&&!!this.AS)&&(this.AS.DA>Gv))BA=
...
0,null),Go:B.abi(10,B.wf,null),D4:B.abi(10,B.wf,null),Db:B.abi(10,B.wf,null),E7:
...
Get(M),this.Cf.Get(M)+1,this.D4.Get(M),false,this.Db.Get(M),this.E7.Get(M)));this.
...
FD.Get(M),this.D5.Get(M),this.Cf.Get(M)+1,this.D4.Get(M),this.Db.Get(M),this.E7.
...
D.Cq.isPrototypeOf(A=this.De)?A:null);var Ey=(D.GF.isPrototypeOf(A=this.De)?A:null
...
null;var K=(D.Cq.isPrototypeOf(A=this.De)?A:null);var Ey=(D.GF.isPrototypeOf(A=this.
...
D.KeyEvent,0).Initialize2(JT,true));if(!(D.GF.isPrototypeOf(A=this.De)?A:null)&&
...
W,this.Go.Get(W),this.FD.Get(W),this.D5.Get(W),this.Cf.Get(W)+1,this.D4.Get(W),false
...
BG(this.SC().Initialize(W,V,this.FD.Get(W),BN,this.D5.Get(W),this.Cf.Get(W)+1,this.
D4.Get(W),B8,this.E7.Get(W)));}this.Bo=0;return true;},DriveCursorHitting:function(
...
,BX.Cq,B8),0x18);this.Be.Set(W,BX.Cq);this.D4.Set(W,BX.DV);}else{this.Be.Set(W,null
);this.D4.Set(W,AG);this.Bo=0;return false;}var Av=BX.Cq.G;while(!!Av&&(Av!==this
...
,V,this.Cf.Get(W)+1,this.D4.Get(W),false,B8));this.Bo=0;return true;}if(!Ew&&!!this.
...
W),this.Cf.Get(W)+1,this.D4.Get(W),false,B8,this.E7.Get(W)));this.BroadcastEvent(
...
1,FA,FC,HW);if(!!BX&&(this.Be.Get(this.AN)!==BX.Cq))this.NR(BX.Cq,BX.DV);if(!BX&&(
...
Get(this.AN),this.D5.Get(this.AN),this.Cf.Get(this.AN)+1,this.D4.Get(this.AN),true
...
this.AN,V);this.Cf.Set(this.AN,0);this.D5.Set(this.AN,0);this.IX.Set(this.AN,ticksCount
);this.E7.Set(this.AN,this.Db.Get(this.AN));this.Be.Get(this.AN).BG(this.HZ().InitializeDown(
this.AN,V,this.Cf.Get(this.AN)+1,this.D4.Get(this.AN),true,this.E7.Get(this.AN))
...
]).__proto__=D.Root.Cf;(this.Ln=[]).__proto__=D.Root.Ln;(this.D5=[]).__proto__=D.
Root.D5;(this.FD=[]).__proto__=D.Root.FD;(this.IX=[]).__proto__=D.Root.IX;(this.
Go=[]).__proto__=D.Root.Go;(this.D4=[]).__proto__=D.Root.D4;(this.Db=[]).__proto__=
D.Root.Db;(this.E7=[]).__proto__=D.Root.E7;(this.Cz=[]).__proto__=D.Root.Cz;(this.
BJ=[]).__proto__=D.Root.BJ;this.__proto__=D.Root;this.F=0x10007F;this.Gp.GK(10);
this.Gp.GP=[this,this.SD];this.CM(aArg);},_Done:function(){this.__proto__=D.H;this.
...
function(W,GW,JV,JW,CR,DZ,Ex,JU){this.Down=true;this.BK=W;this.BV=B.abf(GW,DZ);this.
C5=B.abf(JV,DZ);this.B1=JW;this.Cw=CR;this.C4=Ex;this.Jf=JU;return this;},InitializeUp:
function(W,GW,JV,JW,CR,DZ,HP,Ex,JU){this.Down=false;this.BK=W;this.BV=B.abf(GW,DZ
);this.C5=B.abf(JV,DZ);this.B1=JW;this.Cw=CR;this.CA=HP;this.C4=Ex;this.Jf=JU;return this;
},InitializeDown:function(W,GW,CR,DZ,HP,Ex){this.Down=true;this.BK=W;this.BV=B.abf(
GW,DZ);this.C5=B.abf(GW,DZ);this.B1=0;this.Cw=CR;this.CA=HP;this.C4=Ex;this.Jf=Ex;
return this;},_Init:function(aArg){D.Event._Init.call(this,aArg);this.__proto__=
D.FL;},_className:"Core::CursorEvent"};D.I$={Jf:B.wf,C4:B.wf,Cw:0,B1:0,DV:B.wf,C5:
B.wf,BV:B.wf,BK:0,Initialize:function(W,GW,JV,aOffset,JW,Sn,DZ,Ex,JU){this.BK=W;
this.BV=B.abf(GW,DZ);this.C5=B.abf(JV,DZ);this.DV=aOffset;this.B1=JW;this.Cw=Sn;
...
aaY(C,this.Q))return;var G4=[(A=this.Q)[2]-A[0],A[3]-A[1]];var Ny=[C[2]-C[0],C[3
]-C[1]];var I3=!B.aaX(G4,Ny);var BN=B.abe(C.slice(0,2),this.Q.slice(0,2));if(!B.
aaX(BN,AG)&&!I3){var K=this.Z;while(!!K&&!((K.F&0x200)===0x200)){if(((K.F&0x400)===
0x400)){var tmp=((K.F&0x100)===0x100);K.Mq(BN,tmp);}K=K.Z;}}if((I3&&(G4[0]>0))&&(
G4[1]>0)){var Ax=this.Q;var K=this.Z;while(!!K&&!((K.F&0x200)===0x200)){if(((K.F&
...
,Aw:0,BK:0,AC:0,Cw:0,B1:0,DV:B.wf,C5:B.wf,BV:B.wf,QH:8,NZ:1,Down:false,DT:false,
...
C5;this.BV=Am.BV;this.DV=AG;this.B1=Am.B1;this.Cw=Am.Cw;this.CA=Am.CA;this.BK=Am.
BK;this.AC=Am.AC;if(Am.Down&&!Am.B1)Lt=false;}if(!!B9){this.Down=true;this.DT=this.
Me(B9.BV);this.C5=B9.C5;this.BV=B9.BV;this.DV=B9.DV;this.B1=B9.B1;this.Cw=B9.Cw;
...
Mw:null,GG:null,EU:null,Aw:0,Oh:0,C5:B.wf,NS:0,K5:0,Angle:0,Down:false,DT:false,
...
if(!!An||(LC!==SS))(A=this.Mw)?A[1].call(A[0],this):null;if(B_)(A=this.GG)?A[1].
...
!=E))A._Mark(A._cycle=E);if((A=this.GG)&&((A=A[0])._cycle!=E))A._Mark(A._cycle=E
);if((A=this.EU)&&((A=A[0])._cycle!=E))A._Mark(A._cycle=E);},_className:"Core::RotateTouchHandler"
};D.GF={Z:null,DW:null,BP:null,Ia:0,AC:0,Oi:0,Ca:148,BF:0,AW:0,AM:true,Down:false
...
},_Init:function(aArg){this.__proto__=D.GF;this.CM(aArg);B.h7++;},_Done:function(
...
"Core::KeyPressHandler"};D.KF={Cq:null,I_:0,DV:B.wf,Initialize:function(O,aOffset
...
0,_observers:null,_className:"Core::Resource"};D.Timer={GP:null,timer:null,AC:0,
...
tmp;},GK:function(C){if(C<0)C=0;if(C===this.Period)return;this.Period=C;if(this.
AM)this.LE(this.Ii,C);},GH:function(C){if(C<0)C=0;if(C===this.Ii)return;this.Ii=
...
GP)?A[1].call(A[0],this):null;},_Init:function(aArg){this.__proto__=D.Timer;B.h7++;
},_Done:function(){this.Dk();this.__proto__=null;B.h7--;},_ReInit:function(){},_Mark:
function(E){var A;if((A=this.GP)&&((A=A[0])._cycle!=E))A._Mark(A._cycle=E);if((A=
...
C/60)%60|0;var EC=C%60|0;this.Op=BE+((Df<=2)?1:0);this.Qg(Df);this.GI(d);this.Qb(
...
C){if(C<0)C=0;if(C>23)C=23;this.Ma=C;},GI:function(C){if(C<1)C=1;if(C>31)C=31;this.
