...
0,1);this.Cl.GW.Set(0,1);for(M=1;M<Lk;M=M+1){this.Cl.CG.Set(M,this.Cl.CG.Get(M-1
)*SH);this.Cl.GW.Set(M,this.Cl.GW.Get(M-1)*this.L3);Ic=Ic+this.Cl.CG.Get(M);}var
...
Get(M);}L=(Ck-Fd)/(CZ-Fd);if(!M)L=1-(L*L);else{L=(2*L)-1;L=E9.GW.Get(M)*(1-(L*L)
...
1-(E9.GW.Get(M)*(1-(L*L)));}}break;case 21:{var E9=this.Cl;var M=0;var Fd=0;var CZ=
E9.CG.Get(0);var DG=L*2;var Ck=DG-1;if(DG<1)Ck=-Ck;while(Ck>CZ){M=M+1;Fd=CZ;CZ=CZ+
E9.CG.Get(M);}Ck=(Ck-Fd)/(CZ-Fd);if(!M)Ck=Ck*Ck;else{Ck=(2*Ck)-1;Ck=1-(E9.GW.Get(
...
){var Aq=(this.timer.AC-this.AR)|0;if(Aq<0)Aq=-Aq;var Ds=this.F_;var D9=this.F_+
this.FN;var BD=this.FN;var CU=false;var AD=this.CX;if(!this.A8&&(Aq>=D9)){this.A8=
1;Aq=Aq-D9;this.AR=this.AR+D9;}if((this.A8>0)&&(Aq>=BD)){var BM=(Aq/BD)|0;this.A8=
...
Aq=(this.AR-this.timer.AC)|0;var Ds=this.F_;var D9=this.F_+this.FN;var BD=this.FN;
...
*BD);}if(((this.A8===1)&&(Aq<0))&&(this.Dx>0)){this.A8=0;Aq=Aq+D9;this.AR=this.AR+
D9;}if(((this.A8===1)&&(Aq<0))&&!this.Dx){var BM=(((-Aq+BD)-1)/BD)|0;Aq=Aq+(BM*BD
...
this.AR-this.timer.AC)|0;var Ds=this.F_;var D9=this.F_+this.FN;var BD=this.FN;var
...
}if(((this.A8===1)&&(Aq<0))&&(this.Dx>0)){this.A8=0;Aq=Aq+D9;this.AR=this.AR+D9;
...
timer.AC-this.AR)|0;if(Aq<0)Aq=-Aq;var Ds=this.F_;var D9=this.F_+this.FN;var BD=
this.FN;var CU=false;var AD=this.CX;if(!this.A8&&(Aq>=D9)){this.A8=1;Aq=Aq-D9;this.
AR=this.AR+D9;}if((this.A8>0)&&(Aq>=BD)){var BM=(Aq/BD)|0;this.A8=this.A8+BM;Aq=
...
U;var G6=this.A3&0xFF;var GZ=(this.A3>>8)&0xFF;var GX=(this.A3>>16)&0xFF;var CS=(
this.A3>>24)&0xFF;G6=G6+((((this.A4&0xFF)-G6)*FB)|0);GZ=GZ+(((((this.A4>>8)&0xFF
)-GZ)*FB)|0);GX=GX+(((((this.A4>>16)&0xFF)-GX)*FB)|0);CS=CS+(((((this.A4>>24)&0xFF
)-CS)*FB)|0);if(G6<0)G6=0;if(G6>255)G6=255;if(GZ<0)GZ=0;if(GZ>255)GZ=255;if(GX<0
)GX=0;if(GX>255)GX=255;if(CS<0)CS=0;if(CS>255)CS=255;this.Fu=(G6&0xFF)|((GZ&0xFF
)<<8)|((GX&0xFF)<<16)|((CS&0xFF)<<24);if(!!this.Ad)(U=this.Ad,U[2].call(U[0],this.
...
,G:null,H:null,LA:null,NB:null,Is:null,AY:true,AM:true,GT:true,Ig:false,Ih:true,
Ge:true,EW:true,Di:function(){if(!!this.DO)this.DO.Di();},KO:function(){return true;
},GF:function(){},EU:function(){this.Di();},_Init:function(aArg){this.__proto__=
...
DH:false,KO:function(){return this.DH;},GF:function(){if(!this.AY&&!!this.H.G)this.
...
);if(this.AY&&this.Ih)this.H.G.Dy(this.H);if(this.AY&&!this.GT)this.H.R(B.abJ(this.
...
A6:null,DH:false,KO:function(){return this.DH;},GF:function(){if(this.AY)this.H.
...
if(this.GT){if(this.H.Ek()&&!!this.H.G)this.A6.A3=this.H.Bi;else this.A6.A3=0;}var
...
_className:"Effects::OpacityFader"};D.GP={A2:null,AF:null,DH:false,KO:function(){
return this.DH;},GF:function(){if(this.AY){this.H.Bd(this.A2.A4);this.H.R(B.abJ(
...
var A;if(this.GT){if(this.H.Ek()&&!!this.H.G)this.A2.A3=this.H.Bi;else this.A2.A3=
...
D.GP;},_Done:function(){this.__proto__=D.Dl;this.A2._Done();this.AF._Done();D.Dl.
...
"Effects::PositionFader"};D.Er={Fh:function(){return null;},Hd:function(){return null;
},Hf:function(){return this.Fh();},He:function(){return this.Hd();},_Init:function(
...
Ge=true;I.GT=false;I.Is=[this,this.Kj];return I;},Hd:function(){var I=B._NewObject(
D.IQ,0);I.AY=false;I.AM=false;I.EW=true;return I;},Hf:function(){var I=D.Er.Hf.call(
this);I.Ge=false;I.AM=true;return I;},He:function(){var I=B._NewObject(D.IQ,0);I.
...
"Effects::ShowHideTransition"};D.Jb={Fh:function(){var I=B._NewObject(D.GP,0);I.
AY=true;I.AM=true;I.Ih=false;I.Ge=true;I.GT=true;I.Is=[this,this.Kj];I.A2.Ga(500
);I.A2.A3=0;I.A2.A4=255;I.AF.Ga(500);I.AF.MC(23);return I;},Hd:function(){var I=
B._NewObject(D.ME,0);I.AY=false;I.AM=false;I.EW=true;I.GT=true;I.A6.A3=255;I.A6.
A4=0;I.A6.Ga(500);return I;},Hf:function(){var I=D.Er.Hf.call(this);I.Ge=false;I.
AM=true;return I;},He:function(){var I=D.Er.He.call(this);I.Ig=true;I.EW=false;I.
AM=true;return I;},Kj:function(Ab){var A;var I=(D.GP.isPrototypeOf(Ab)?Ab:null);
...
B._NewObject(D.GP,0);I.AY=true;I.AM=true;I.Ih=false;I.Ge=true;I.GT=true;I.Is=[this
...
return I;},Hd:function(){var I=B._NewObject(D.GP,0);I.AY=false;I.AM=false;I.EW=true;
I.GT=true;I.Is=[this,this.SX];I.A2.A3=255;I.A2.A4=0;I.A2.Ga(500);I.A2.Jk(0);I.AF.
Ga(500);I.AF.MC(23);I.AF.Od(0);I.AF.Oe(0);I.AF.N8(3);I.AF.N4(0.5);I.AF.N$(3);I.AF.
N5(3);I.AF.N7(0.5);return I;},Hf:function(){var I=D.Er.Hf.call(this);I.Ge=false;
I.AM=true;return I;},He:function(){var I=D.Er.He.call(this);I.Ig=true;I.EW=false;
I.AM=true;return I;},Kj:function(Ab){var A;var I=(D.GP.isPrototypeOf(Ab)?Ab:null
...
A[3]))){var D_=[(A=I.G.Q)[2]-A[0],A[3]-A[1]];switch(this.KI){case 5:V=[V[0],-AV[
1]];break;case 3:{V=[V[0],-AV[1]];V=[D_[0],V[1]];}break;case 8:V=[-AV[0],-AV[1]];
break;case 2:V=[D_[0],V[1]];break;case 7:V=[-AV[0],V[1]];break;case 4:V=[V[0],D_[
1]];break;case 1:{V=[V[0],D_[1]];V=[D_[0],V[1]];}break;case 6:{V=[V[0],D_[1]];V=[-
...
,A[3]-A[1]];var D_=[(A=I.G.Q)[2]-A[0],A[3]-A[1]];switch(this.KI){case 5:V=[V[0],
D_[1]];break;case 3:{V=[V[0],D_[1]];V=[-AV[0],V[1]];}break;case 8:{V=[V[0],D_[1]
];V=[D_[0],V[1]];}break;case 2:V=[-AV[0],V[1]];break;case 7:V=[D_[0],V[1]];break;
case 4:V=[V[0],-AV[1]];break;case 1:V=[-AV[0],-AV[1]];break;case 6:{V=[V[0],-AV[
1]];V=[D_[0],V[1]];}break;default:;}I.AF.A4=V;},_Init:function(aArg){D.Er._Init.
...
null),GW:B.abi(12,0,null),_Init:function(aArg){(this.CG=[]).__proto__=D.K9.CG;(this.
GW=[]).__proto__=D.K9.GW;this.__proto__=D.K9;B.h7++;},_Done:function(){this.__proto__=
...
};D.KL={AS:null,AO:null,N1:function(JX){var I=this.AO;while(!!I){I.GF();I.H.F=I.
...
IQ.__proto__=D.Dl;D.ME.__proto__=D.Dl;D.GP.__proto__=D.Dl;D.MJ.__proto__=D.Er;D.
