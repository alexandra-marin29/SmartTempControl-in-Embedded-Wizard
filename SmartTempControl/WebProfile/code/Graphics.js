...
var Ca=[0,0,0,0];var EH="No graphics engine bitmap attached to this canvas";var DT=
...
"being wider or higher than 4069 pixel.";var DU="ScaleBitmap() operation has been omitted due to the resulting area "+
"being wider or higher than 4069 pixel.";
D.Canvas={G$:null,H_:B.wg,Da:0,IE:false,C3:function(){if(this.IE)this.DetachBitmap(
);},Cu:function(aArg){this.Ey=true;},Mm:function(C){if((C[0]<=0)||(C[1]<=0))C=AH;
...
Da--)this.Kw(this.H_,this.H_,0x00000000,0x00000000,0x00000000,0x00000000,false);
this.Da=dstFrameNr;}}if(!(((A=this.H_)[0]>=A[2])||(A[1]>=A[3])))this.H_=Ca;},DetachBitmap:
...
function(aBitmap){if(!!this.bitmap)throw new Error(DT);if(!aBitmap)return this;this.
...
270;var dstFrameNo=this.Da;var dstBitmap=this.bitmap;var srcFont=Ly.font;{B.rz(dstBitmap
,srcFont,aString,aOffset,aCount,dstFrameNo,aClip,aDstRect,aSrcPos,aMinWidth,orient
,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},NR:function(aClip,aBitmap,aFrameNr
...
Da;var path=LB.path;{B.ab3(dstBitmap,path,dstFrameNo,aClip,aDstRect,aFlipY,aOffset
...
,aFilter);}},OK:function(aClip,aBitmap,aFrameNr,aDstRect,aSrcRect,aColorTL,aColorTR
...
)||((bottom-top)<-4096)){B.ab5("%s",DU);return;}var dstBitmap=this.bitmap;var srcBitmap=
...
,aDstRect,aSrcRect,aSrcPos,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},NN:function(
...
NS:function(aClip,aDstRect,aEdgeWidth,aColorTL,aColorTR,aColorBR,aColorBL,aBlend
...
acg.Q._Init.call(this,aArg);this.__proto__=D.Canvas;this.Cu(aArg);},_Done:function(
){this.C3();this.__proto__=B.acg.Q;B.acg.Q._Done.call(this);},_Mark:function(E){
var A;B.acg.Q._Mark.call(this,E);if((A=this.G$)&&(A._cycle!=E))A._Mark(A._cycle=
E);},_className:"Graphics::Canvas"};D.Mx={N1:1,N2:0,N3:0,N4:0,N5:1,N6:0,Jn:0,Jo:
0,N7:1,Mh:0,Iw:0,Qq:true,Jd:function(aX,aY){var H1=((aX*this.Jn)+(aY*this.Jo))+this.
Mh;this.Iw=H1;return true;},NP:function(JJ,JM,JK,JN,LD,LE,JL,JO){var MX=JK-LD;var
MZ=JN-LE;var MY=JL-LD;var M0=JO-LE;var Nq=((JJ-JK)+LD)-JL;var Nr=((JM-JN)+LE)-JO;
var LJ=(MX*M0)-(MZ*MY);if(!LJ)return null;this.Jn=((Nq*M0)-(Nr*MY))/LJ;this.Jo=((
MX*Nr)-(MZ*Nq))/LJ;this.N7=0;this.Mh=1;this.N1=(JK-JJ)+(this.Jn*JK);this.N2=(JL-
JJ)+(this.Jo*JL);this.N3=JJ;this.N4=(JN-JM)+(this.Jn*JN);this.N5=(JO-JM)+(this.Jo
*JO);this.N6=JM;this.Qq=false;return this;},_Init:function(aArg){this.__proto__=
...
,_cycle:0,_observers:null,_className:"Graphics::WarpMatrix"};D.C4={path:null,C3:
function(){if(!this.path)return;var handle=this.path;B.e6(handle);this.path=null;
},I0:function(Ap){B.we(this,0);},NC:function(aSubPathNo,aCenterX,aCenterY,aRadiusX
...
,aRadiusY,aStartAngle,aEndAngle,aNoOfEdges);}return result;},ND:function(aSubPathNo
...
B.rI(handle,aAngle);},NV:function(){if(!this.path)return 1;var handle=this.path;
var result=0;result=B.aax(handle);return result;},Mw:function(aMaxNoOfSubPaths){
if(aMaxNoOfSubPaths<1)aMaxNoOfSubPaths=1;if(!!this.path&&(this.NV()===aMaxNoOfSubPaths
...
){this.__proto__=D.C4;B.h7++;},_Done:function(){this.C3();this.__proto__=null;B.
...
};D.H6={Left:0x1,RB:0x2,Right:0x4,QR:0x8,Q6:0x10};D.Rg={QQ:0,Ra:1,OJ:2};D.Rf={Q0:
0,Ry:1,OJ:2,RG:3};
