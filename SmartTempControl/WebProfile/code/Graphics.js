...
var Cd=[0,0,0,0];var Et="No graphics engine bitmap attached to this canvas";var DB=
...
D.Canvas={Ba:null,Jg:B.wg,Dv:0,JZ:false,Dk:function(){if(this.JZ)this.DetachBitmap(
);},CM:function(aArg){this.Fn=true;},N9:function(C){if((C[0]<=0)||(C[1]<=0))C=AG;
if(B.aaX(C,this.FrameSize))return;if(this.JZ)throw new Error(AZ);this.FrameSize=
C;this.B$=(((this.FrameSize[0]>0)&&(this.FrameSize[1]>0))&&(this.FrameDelay>0))&&(
...
AG;this.FrameDelay=0;this.NoOfFrames=1;}this.Jg=[].concat(AG,this.FrameSize);if(
!!this.bitmap){var dstFrameNr=this.Dv;for(this.Dv=this.NoOfFrames-1;this.Dv>=0;this.
Dv--)this.L6(this.Jg,this.Jg,0x00000000,0x00000000,0x00000000,0x00000000,false);
this.Dv=dstFrameNr;}}if(!(((A=this.Jg)[0]>=A[2])||(A[1]>=A[3])))this.Jg=Cd;},DetachBitmap:
function(){if(!this.JZ)throw new Error(Et);this.bitmap=null;this.JZ=false;this.FrameSize=
AG;this.FrameDelay=0;this.NoOfFrames=1;this.B$=false;return this;},AttachBitmap:
function(aBitmap){if(!!this.bitmap)throw new Error(DB);if(!aBitmap)return this;this.
bitmap=aBitmap;this.JZ=true;var noOfFrames=1;var frameSize=AG;var frameDelay=0;{
...
this.B$=(this.FrameDelay>0)&&(this.NoOfFrames>1);return this;},NU:function(aClip
...
270;var dstFrameNo=this.Dv;var dstBitmap=this.bitmap;var srcFont=M8.font;{B.rz(dstBitmap
...
aBitmap.bitmap;var dstFrameNo=this.Dv;var srcRect=[].concat(AG,aBitmap.FrameSize
...
,aColorTR,aColorBR,aColorBL,aBlend);}},JB:function(aClip,M$,aDstRect,aFlipY,aOffset
...
Dv;var path=M$.path;{B.ab3(dstBitmap,path,dstFrameNo,aClip,aDstRect,aFlipY,aOffset
...
}var dstBitmap=this.bitmap;var srcBitmap=aBitmap.bitmap;var dstFrameNr=this.Dv;{
...
this.bitmap;var srcBitmap=aBitmap.bitmap;var dstFrameNo=this.Dv;{B.ab6(dstBitmap
...
bitmap;var srcBitmap=aBitmap.bitmap;var dstFrameNr=this.Dv;{B.gN(dstBitmap,srcBitmap
...
Dv;{B.db(dstBitmap,srcBitmap,dstFrameNr,aFrameNr,aClip,aDstRect,aSrcPos,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend);}},PP:function(aClip,aDstRect,aEdgeWidth,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap
)return;var dstBitmap=this.bitmap;var dstFrameNo=this.Dv;{B.m6(dstBitmap,dstFrameNo
,aClip,aDstRect,aEdgeWidth,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},L6:function(
aClip,aDstRect,aColorTL,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.
Update();if(!this.bitmap)return;var dstBitmap=this.bitmap;var dstFrameNo=this.Dv;{
...
this.CM(aArg);},_Done:function(){this.Dk();this.__proto__=B.acg.T;B.acg.T._Done.
...
0,P1:0,P2:0,P3:1,P4:0,KR:0,KS:0,P5:1,NY:0,JM:0,SO:true,KD:function(aX,aY){var I6=((
aX*this.KR)+(aY*this.KS))+this.NY;this.JM=I6;return true;},PM:function(Ld,Lg,Le,
...
};D.Dm={path:null,Dk:function(){if(!this.path)return;var handle=this.path;B.e6(handle
);this.path=null;},Km:function(Ab){B.we(this,0);},Pv:function(aSubPathNo,aCenterX
,aCenterY,aRadiusX,aRadiusY,aStartAngle,aEndAngle,aNoOfEdges){B.pe([this,this.Km
...
function(aSubPathNo,aX,aY){B.pe([this,this.Km],this);var handle=this.path;var result=
0;result=B.m5(handle,aSubPathNo,aX,aY);return result;},Ii:function(aSubPathNo,aX
,aY){B.pe([this,this.Km],this);var handle=this.path;B.rt(handle,aSubPathNo,aX,aY
);},NX:function(aSubPathNo,aMaxNoOfEdges){if(!this.path&&!aSubPathNo)this.Om(1);
B.pe([this,this.Km],this);var handle=this.path;var result=false;result=B.gM(handle
...
k_(aMaxNoOfSubPaths);}this.path=handle;B.pe([this,this.Km],this);return!!this.path;
},_Init:function(aArg){this.__proto__=D.Dm;B.h7++;},_Done:function(){this.Dk();this.
...
"Graphics::Path"};D.Ja={Left:0x1,QQ:0x2,Right:0x4,PD:0x8,TZ:0x10};D.T$={Tq:0,T6:
1,QJ:2};D.T_={TS:0,Uy:1,QJ:2,UH:3};
