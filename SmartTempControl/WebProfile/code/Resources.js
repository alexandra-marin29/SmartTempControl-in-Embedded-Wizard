...
D.T={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:B.wf,Fn:false,B_:false,Dj:function(
){if(!this.bitmap)return;var handle=this.bitmap;B._FreeBitmap(handle);this.bitmap=
null;this.FrameSize=AG;this.FrameDelay=0;this.NoOfFrames=1;this.B_=false;},CL:function(
...
this.FrameSize=frameSize;this.FrameDelay=frameDelay;this.Fn=true;this.B_=(!!this.
...
__proto__=D.T;this.CL(aArg);},_Done:function(){this.Dj();this.__proto__=B.Core.Gd;
B.Core.Gd._Done.call(this);},_className:"Resources::Bitmap"};D.B0={font:null,Leading:
0,Descent:0,Ascent:0,Dj:function(){this.SJ();},CL:function(aArg){this.SP(aArg);}
...
},Jd:function(aString,aOffset,aCount){if(aOffset<0)aOffset=0;if(!this.font||((aOffset>
0)&&(aOffset>=aString.length)))return 0;var handle=this.font;var advance=0;advance=
B.m9(handle,aString,aOffset,aCount);return advance;},_Init:function(aArg){B.Core.
Gd._Init.call(this,aArg);this.__proto__=D.B0;this.CL(aArg);},_Done:function(){this.
Dj();this.__proto__=B.Core.Gd;B.Core.Gd._Done.call(this);},_className:"Resources::Font"
