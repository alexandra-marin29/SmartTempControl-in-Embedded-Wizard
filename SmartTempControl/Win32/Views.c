...
/* 'C' function for method : 'Views::Border.OnSetColorBL()' */
void ViewsBorder_OnSetColorBL( ViewsBorder _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorBL ))
    return;
...
/* 'C' function for method : 'Views::Border.OnSetColorBR()' */
void ViewsBorder_OnSetColorBR( ViewsBorder _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorBR ))
    return;
...
/* 'C' function for method : 'Views::Border.OnSetColorTR()' */
void ViewsBorder_OnSetColorTR( ViewsBorder _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorTR ))
    return;
...
/* 'C' function for method : 'Views::Border.OnSetColorTL()' */
void ViewsBorder_OnSetColorTL( ViewsBorder _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorTL ))
    return;
  ...
  aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  if (( !EwCompColor( ctl, _Const0000 ) && !EwCompColor( ctl, _Const0000 )) && !EwCompColor( 
    ...
    if ( EwCompColor( c, _Const0000 ))
    {
      ...
      ctr.Green = (XUInt8)(( ctr.Green * ( c.Green + 1 )) >> 8 );
      ctr.Blue = (XUInt8)(( ctr.Blue * ( c.Blue + 1 )) >> 8 );
      cbl.Alpha = (XUInt8)(( 255 * ( c.Alpha + 1 )) >> 8 );
      cbl.Red = (XUInt8)(( cbl.Red * ( c.Red + 1 )) >> 8 );
      cbl.Green = (XUInt8)(( cbl.Green * ( c.Green + 1 )) >> 8 );
      cbl.Blue = (XUInt8)(( cbl.Blue * ( c.Blue + 1 )) >> 8 );
  ...
  XPoint aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  _Const0001, ctl, ctr, cbr, cbl, aBlend );
}
...
EW_DEFINE_CLASS( ViewsWallpaper, CoreRectView, timer, timer, animFrameNumber, animFrameNumber, 
                 animFrameNumber, animFrameNumber, "Views::Wallpaper" )
  CoreRectView_initLayoutContext,
  CoreView_GetRoot,
  ViewsWallpaper_Draw,
  CoreView_GetClipping,
